...
import 'package:xozmag_admin/features/catalogs/ui/widgets/subcategory_body.dart';
...
class CreateSubcategorySection extends StatelessWidget {
  const CreateSubcategorySection({super.key});
    ...
    return SingleChildScrollView(
      child: Container(
        ...
        child: ChangeNotifierProvider(
          create: (context) => CreateSubcategoryController(),
          child: Column(
                    ...
                    Expanded(
                      child: Column(
                        ...
                        children: [
                          ...
                          const Height(4),
                          Text(
                            'subcategory.create_subtitle'.tr(),
